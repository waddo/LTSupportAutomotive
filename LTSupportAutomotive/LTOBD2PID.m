...
{
    NSMutableArray* arr = @[[LTOBD2PID_SUPPORTED_COMMANDS1_00 pidForMode1],
                                        ...
                                        [LTOBD2PID_OXYGEN_SENSORS_PRESENT_2_BANKS_13 pidForMode1]].mutableCopy;
    for ( NSUInteger i = 0; i < 8; ++i )
    {
        [arr addObject:[LTOBD2PID_OXYGEN_SENSORS_INFO_1 pidForSensor:i mode:1]];
    }
    ...
    for ( NSUInteger i = 0; i < 8; ++i )
    {
        [arr addObject:[LTOBD2PID_OXYGEN_SENSORS_INFO_2 pidForSensor:i mode:1]];
    }
    [arr addObjectsFromArray: @[[LTOBD2PID_COMMANDED_EGR_2C pidForMode1],
    ...
    for ( NSUInteger i = 0; i < 8; ++i )
    {
        [arr addObject:[LTOBD2PID_OXYGEN_SENSORS_INFO_3 pidForSensor:i mode:1]];
    }
    [arr addObjectsFromArray: @[[LTOBD2PID_CATALYST_TEMP_B1S1_3C pidForMode1],
